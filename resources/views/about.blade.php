...
<div class="our_team_member" style="padding: 100px 0 100px 0;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-3 col-md-6 col-lg-3">
                <div class="single_team">
                    <div class="thumb">
                        <img src="img/team/MrGallardo12.jpg" alt="">
                        <div class="social_link">
                            <a href="mailto:jgallardo@mrpython.xyz"><i class="fa fa-envelope"></i></a>
                            <a href="https://www.facebook.com/jgallardo12" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://www.linkedin.com/in/jgallardo12/" target="_blank"><i class="fa fa-linkedin"></i></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="testmonial_text text-center">
                            ...
                            <p>
                                "Working in conjunction with humanitarian aid <br> agencies we have supported programmes to <br> alleviate. human suffering.
